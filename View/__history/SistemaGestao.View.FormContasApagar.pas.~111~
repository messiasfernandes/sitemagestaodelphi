...
begin
  ...
  carregaEdit;
      ...
      begin
        voltar;
        raise Exception.Create('É necessário selecionar uma linha para pagar uma compra');
...
begin
 ...
 (StringReplace(edt_valorPago.Text, '.', '', [rfReplaceAll]), 0);
  ...
  begin
     raise Exception.Create('O valor a ser pago não pode igual a 0 ou menor que  0');
