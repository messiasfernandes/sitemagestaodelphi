...
var dataVstring, datapagamento,datalcto : string;
 jsoncidade,Jsoncliente :TJSONObject;
begin
       datalcto:=(FormatDateTime('dd/mm/YYYY',datalancamento));
      ...
      json.AddPair('valoprago',TJSONNumber.Create(valoprago));
       json.AddPair('idcocontaMovimento',TJSONNumber.Create(idcocontaMovimento));
   json.AddPair('dataDePagamento',datapagamento) ;

     json.AddPair('datavencimento', dataVstring);
     json.AddPair('datalancamento',datalcto);
    ...
    /// jssondicao:=TJSONObject.Create;
     Jsoncliente.AddPair('codigo',fornecedor.codigo.ToString);
//     jssondicao.AddPair('idcondicao',fornecedor.condicaocondicaoPamento.idcondicao.ToString);
    json.AddPair('fornecedor',Jsoncliente);
