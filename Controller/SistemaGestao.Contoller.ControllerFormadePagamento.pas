          ...
          function buscarTodos(colecao: TObjectList<TFormadePagamento> ): TObjectList<TFormadePagamento>;
           ...
           destructor Destroy;override;
            procedure conhecaUsuario(usuario: TUsuarioComToken);
                function buscar:TFormadepagamento;
        published
...
function TControllerFormadePagamento.buscar: TFormadepagamento;
begin
...
function TControllerFormadePagamento.carregar(objeto: TFormadePagamento;
